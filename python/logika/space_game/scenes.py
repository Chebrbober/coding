# Цей модуль містить різні "сцени" для гри, такі як:
# Головне меню з кнопками, вибір рівня, сама гра, екран перемоги або поразки
# Кожна сцена знає, що їй робити і коли передати керування наступній
import pygame
