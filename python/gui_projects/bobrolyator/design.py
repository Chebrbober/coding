...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_koren = QPushButton(self.centralwidget)
        self.btn_koren.setObjectName(u"btn_koren")
        sizePolicy2.setHeightForWidth(self.btn_koren.sizePolicy().hasHeightForWidth())
        self.btn_koren.setSizePolicy(sizePolicy2)
        self.btn_koren.setCursor(QCursor(Qt.PointingHandCursor))

        self.layout_buttons.addWidget(self.btn_koren, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"BOBROLYATOR", None))
        ...
        self.btn_koren.setText(QCoreApplication.translate("MainWindow", u"√", None))
